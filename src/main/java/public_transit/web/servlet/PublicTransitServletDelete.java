...
public class PublicTransitServletDelete extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PublicTransitServletDelete() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(method.equals("search"))
		{
			...
			if(pt.getTransitType()!=null){
				...
				request.getRequestDispatcher("/jsps/public_transit/public_transit_delete_output.jsp").forward(request, response);
			...
			try {
				service.deletePublicTransit(request.getParameter("TransitType"), request.getParameter("TransitEmissionType"));
